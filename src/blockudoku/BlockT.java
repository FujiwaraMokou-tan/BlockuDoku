...
/**
 * This class works as a way to create block named "BlocoT"
 *
...
public class BlockT extends Block
{
    ...
    /**
     * Constructor for objects of class BlockTExtended, it receives the data from its subclass and sends it to the top of the hierarchy
     ...
     */
    public BlockT(int gameMode,int pivotX, int pivotY, int xLength, int yLength, int points)
    {
