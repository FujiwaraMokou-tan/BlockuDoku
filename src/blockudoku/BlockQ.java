...
/**
 * This class works as a way to create block named "BlocoQ"
 *
...
{
    /**
     * Constructor for objects of class BlockQ, sends all the required information to Superclass
     */
    public BlockQ()
    {
        super(1, 1, 1, 3, 3, 4);
    ...
    /**
     * Constructor for objects of class BlockQExtended, it receives the data from its subclass and sends it to the top of the hierarchy
     ...
     */
    public BlockQ(int gameMode,int pivotX, int pivotY, int xLength, int yLength, int points)
    {
